jQuery(function($){if(typeof wc_country_select_params==="undefined"||typeof woot_select_params==="undefined"){return!1}
...
$citybox.html('<option value="">'+woot_select_params.i18n_select_city_text+"</option>"+options);if($('option[value="'+value+'"]',$citybox).length){$citybox.val(value).change()}else{$citybox.val("").change()}
