jQuery(function ($) {
  ...
  /* City select boxes */
  var cities_json = woot_select_params.cities.replace(/&quot;/g, '"');
  ...
  function cityToSelect($citybox, current_cities) {
    ...
    $citybox.html(
      '<option value="">' +
        woot_select_params.i18n_select_city_text +
        "</option>" +
        options
    );
